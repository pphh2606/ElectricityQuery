...
@Composable
internal fun rememberWebViewDarkModeState(): State<Boolean> {
    val settings = LocalAppSettingsState.current
...
internal fun WebView.applyWebViewDarkMode(enabled: Boolean) {
