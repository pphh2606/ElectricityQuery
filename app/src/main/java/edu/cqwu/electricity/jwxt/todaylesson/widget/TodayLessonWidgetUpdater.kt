package edu.cqwu.electricity.jwxt.todaylesson.widget

import android.appwidget.AppWidgetManager
import android.content.ComponentName
import android.content.Context
import edu.cqwu.electricity.R
import edu.cqwu.electricity.jwxt.todaylesson.data.TodayLessonPayload
 ...
 * 小组件刷新入口（统一出口）。
 *
 * 只做「读缓存 → 渲染」：桌面上的内容来自 [TodayLessonRepository] 落盘的缓存，不联网，
 * 因此无论从 App 内还是系统广播进来都能立刻出画面。
 */
