...
import edu.cqwu.electricity.data.model.OrderStatusData
 ...
 * 电费充值支付 API 封装
 *
 * 对标 [edu.cqwu.electricity.data.network.pay.cardrecharge.CardRechargeApi]，
 ...
 * 对标校园卡的 [edu.cqwu.electricity.data.network.pay.cardrecharge.CardPaymentResult]。
 *
