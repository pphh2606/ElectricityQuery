 ...
 * 支付 API 公共基类
 *
 * 提取 [edu.cqwu.electricity.data.network.pay.electricityrecharge.ElectricityPayApi] 和
 * [edu.cqwu.electricity.data.network.pay.cardrecharge.CardRechargeApi] 的公共逻辑：
 * - [PAY_DOMAIN] 常量
 * - [client] / [gson] 实例
